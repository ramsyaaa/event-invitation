                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Email Invitation List List</h4>
                                <a href="{{ url('/admin/email-invitation-list' . '/create') }}" class="btn btn-success mr-2">
                        ...
                        <div class="card-body px-0">
                            <div class="table-responsive">
                                <table id="user-list-table" class="table table-striped" role="grid"
                                    ...
                                    <tbody>
                                        @foreach ($emailinvitationlist as $i => $item)
                                            <tr>
                                                <td>{{ $i + 1 }}</td>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip"
                                                            ...
                                                            href="{{ url('/admin/email-invitation-list/' . $item->id) }}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                                            ...
                                                            href="{{ url('/admin/email-invitation-list/' . $item->id . '/edit') }}">
                                                            <span class="btn-inner">
                                                        ...
                                                        {!! Form::open([
                                                            'method' => 'DELETE',
                                                            'url' => ['/admin/email-invitation-list', $item->id],
