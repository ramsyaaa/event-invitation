                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Company Category List</h4>
                                <a href="{{ url('/admin/company-category' . '/create') }}" class="btn btn-success mr-2">
                        ...
                        <div class="card-body px-0">
                            <div class="table-responsive">
                                <table id="user-list-table" class="table table-striped" role="grid"
                                    ...
                                    <tbody>
                                        @foreach ($companycategory as $i => $item)
                                            <tr>
                                                <td>{{ $i + 1 }}</td>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip"
                                                            ...
                                                            href="{{ url('/admin/company-category/' . $item->id) }}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                                            ...
                                                            href="{{ url('/admin/company-category/' . $item->id . '/edit') }}">
                                                            <span class="btn-inner">
                                                        ...
                                                        {!! Form::open([
                                                            'method' => 'DELETE',
                                                            'url' => ['/admin/company-category', $item->id],
