                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Company Subcategory List</h4>
                                <a href="{{ url('/admin/company-subcategory' . '/create') }}" class="btn btn-success mr-2">
                            ...
                            <div class="table-responsive">
                                <table id="user-list-table" class="table table-striped" role="grid"
                                    ...
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Company Category Id</th>
                                            <th>Subcategory Name</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($companysubcategory as $i => $item)
                                            <tr>
                                                <td>{{ $i + 1 }}</td>
                                                <td>{{ $item->company_category_id }}</td>
                                                <td>{{ $item->subcategory_name }}</td>
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="View"
                                                            href="{{ url('/admin/company-subcategory/' . $item->id) }}">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                                            ...
                                                            href="{{ url('/admin/company-subcategory/' . $item->id . '/edit') }}">
                                                            <span class="btn-inner">
                                                        ...
                                                        {!! Form::open([
                                                            'method' => 'DELETE',
                                                            'url' => ['/admin/company-subcategory', $item->id],
